...
public class CMMetricsLogger extends MetricsLogger {
    ...
    // CMRemix
    public static final int TILE_BRIGHTNESS = BASE + 44;
    public static final int TILE_EXPANDED_DESKTOP = BASE + 45;
    public static final int TILE_SCREEN_OFF = BASE + 46;
    public static final int TILE_SCREENSHOT = BASE + 47;
    public static final int CMREMIX_SETTINGS = BASE + 48;

    public static final int ACTION_FRAGMENT = BASE + 49;
    public static final int AMBIENT_SETTINGS = BASE + 50;
    public static final int BATTERY_BAR = BASE + 51;
    public static final int FLING_SETTINGS = BASE + 52;
    public static final int INPUT_METHODS_SETTINGS = BASE + 53;
    public static final int LOCKSCREEN_SETTINGS = BASE + 54;
    public static final int LOCK_CLOCK = BASE + 55;
    public static final int LOCKSCREEN_SHORTCUT_FRAGMENT = BASE + 56;
    public static final int LOCKSCREEN_WALLPAPER = BASE + 57;
    public static final int LOCKSCREEN_WEATHER_SETTINGS = BASE + 58;
    public static final int NAVIGATION_BAR = BASE + 59;
